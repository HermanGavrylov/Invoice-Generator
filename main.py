...
for filepath in filepaths:
    ...
    pdf.cell(w=50, h=8, txt=columns[4], border=1, ln=1)
    ...
    pdf.cell(w=50, h=8, txt=str(total_sum), border=1, ln=1)
    ...
    pdf.set_font(family="Times", size=14, style="B")
    pdf.cell(w=30, h=8, txt=f"GavrylovINC")
    pdf.image("gavrylov.png", w=10)
